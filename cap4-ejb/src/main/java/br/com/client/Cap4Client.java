...
/**
 * java:global/cap4-ejb/SimpleCalculatorBean!br.com.ejb.CalculatorRemoteBusiness
 * java:app/cap4-ejb/SimpleCalculatorBean!br.com.ejb.CalculatorRemoteBusiness
 * java:module/SimpleCalculatorBean!br.com.ejb.CalculatorRemoteBusiness
 * java:jboss/exported/cap4-ejb/SimpleCalculatorBean!br.com.ejb.CalculatorRemoteBusiness
...
public class Cap4Client {
	 ...
	 */
	private static final String JNDI_NAME = "cap4-ejb/SimpleCalculatorBean!br.com.ejb.CalculatorRemoteBusiness";
	...
	public static void main(String[] args) throws NamingException {
		 ...
		 */
//		CalculatorCommomBusiness calculatorCommomBusiness = (CalculatorCommomBusiness) context.lookup(JNDI_NAME);
//		System.out.println(calculatorCommomBusiness.multiply(2, 2));
//		System.out.println(calculatorCommomBusiness.sum(10, 10, 3));

		CalculatorRemoteBusiness calculatorRemoteBusiness = (CalculatorRemoteBusiness) context.lookup(JNDI_NAME);
